      ...
      <main className=' bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40'>
        ...
        <section class="bg-white dark:bg-gray-900">
          <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
              <h2 class="mb-4 text-4xl tracking-tight font-bold text-center text-gray-900 dark:text-white">Let's build together</h2>
              <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Curious to learn more? Contact me below!</p>
