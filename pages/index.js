      ...
      <main className=' bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40'>
          ...
          <div className='mx-auto'>
            <div className='grid items-center grid-cols-1 md:grid-cols-2'>
              ...
              <div className='relative justify-end'>
                <Image src={toronto} alt='' class='relative w-full xl:mx-auto 2xl:origin-bottom 2xl:scale-110 rounded-md'/>
                {/* <img
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
              <h2 className="mb-4 text-4xl tracking-tight font-bold text-center text-gray-900 dark:text-white">Let&apos;s build together</h2>
              <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Curious to learn more? Contact me below!</p>
